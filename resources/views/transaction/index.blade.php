 ...
 @section('content')
     ...
     <div class="row">
         <div class="col-md-7">
             ...
             <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-3 mt-2" id="ticketList"></div>
         ...
         <div class="col-md-5">
             ...
             <div class="text-center mt-3">
                 <a href="javascript:;" id="deleteAll">Delete All (0)</a>
             </div>
             <div class="card mt-5 ">
         ...
         <div class="modal-dialog modal-sm">
             <div class="modal-content">
                 ...
                 <div class="modal-body">
                     <input type="number" id="ticketQtyInput" class="form-control" min="1" value="1">
 ...
 @section('script')
     <script>
         ...
         const ticketComponent = (r) => {
             ...
             return ` <div class="col wahana-list">
                     <div class="wahana-card" data-id="${r.id}" data-price="${r.price}" data-type="${r.type}"  data-detail="${detailEncoded}">
     ...
     <script>
         ...
         const anAmount = new AutoNumeric('#amountGiven', {
             digitGroupSeparator: '.',
             decimalCharacter: ',',
             currencySymbol: 'Rp ',
         ...
         amountGiven.addEventListener('input', function() {
             const totalHarga = parseFloat(paymentTotal.value);
             const given = anAmount.getNumber(); // AutoNumeric unformat
             const kembali = given - totalHarga;

             kembalianText.textContent = kembali >= 0 ?
