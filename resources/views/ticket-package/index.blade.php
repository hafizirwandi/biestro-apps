 ...
 @section('content')
     ...
     @can('ticket-package-create')
         <a href="{{ route('ticket-package.create') }}"
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <div class="d-flex align-items-center">
                                         ...
                                         @can('ticket-package-edit')
                                             <a href="{{ route('ticket-package.edit', $r->id) }}" class="text-body">
                                                 <i class="ti ti-edit ti-sm me-2"></i>
                                             </a>
                                         @endcan
                                         @can('ticket-package-delete')
                                             ...
                                             <form id="delete-form-{{ $r->id }}" method="post"
                                                 action="{{ route('ticket-package.destroy') }}" style="display: none;">
                                                 @csrf
                                                 @method('delete')
