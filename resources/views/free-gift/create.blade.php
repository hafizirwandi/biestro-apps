 ...
 @section('content')
     ...
     <form class="row g-3" method="post" action="{{ route('free-gift.store') }}">
         @csrf
                     ...
                     <div class="card-body">
                         <div class="row">
                             ...
                             <div class="col-6 col-md-6 mb-3">
                                 ...
                                 <select name="is_multiple" class="form-control" placeholder="Enter Text" required>
                         ...
                         <div class="row">
                             <div class="col-6 col-md-6 mb-3">
                                 ...
                                 <input type="text" name="min_purchase" class="form-control auto-numeric"
